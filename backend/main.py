...
def generate_weekly_summary(data: WeeklySummaryRequest, password: str = ""):
    ...
    prompt = (
        ...
        "Analyze the daily reports and group all work by project or area. "
        "Common project areas include: Dashboard, Auth / Access, Payouts, Call Center, "
        "Homepage, CRM, Infrastructure / DevOps, Management, Support, AI Tools, and others — "
        "infer the correct project name from the content.\n\n"
        "Rules:\n"
        "- Identify 3–7 distinct project areas from the data.\n"
        "- Under each project, write 2–6 short bullet points (max 12 words each).\n"
        "- Each bullet = one specific completed task, fix, or decision. Past tense.\n"
        "- Include technical details inline (system name, number, specific fix).\n"
        "- Do NOT skip support work, investigations, or management tasks.\n"
        "- Do NOT merge unrelated items into one bullet.\n"
        "- If an item does not fit any project, put it under 'Other'.\n\n"
        "Return ONLY valid HTML using this exact structure — no prose, no markdown, no extra tags:\n\n"
        "<div>\n"
        "  <div class=\"project-group\">\n"
        "    <div class=\"project-title\">Project Name</div>\n"
        "    <ul>\n"
        "      <li>Short bullet point here</li>\n"
